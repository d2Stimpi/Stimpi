...
#define PIN_DATA_TYPE_TO_STRING_CASE(type)	case NPin::DataType::type:	return #type;
		...
		switch (dataType)
		{
			...
			// Complex types
			PIN_DATA_TYPE_TO_STRING_CASE(AnimSprite);
			PIN_DATA_TYPE_TO_STRING_CASE(Animation);
			PIN_DATA_TYPE_TO_STRING_CASE(Materia);
			PIN_DATA_TYPE_TO_STRING_CASE(SubTexture);
...
#define STRING_TO_PIN_DATA_TYPE_STATEMENT(type)	if (string == #type)	return NPin::DataType::type;
		...
		// Complex types
		STRING_TO_PIN_DATA_TYPE_STATEMENT(AnimSprite);
		STRING_TO_PIN_DATA_TYPE_STATEMENT(Animation);
		STRING_TO_PIN_DATA_TYPE_STATEMENT(Materia);
		STRING_TO_PIN_DATA_TYPE_STATEMENT(SubTexture);
		// Primitive like types
